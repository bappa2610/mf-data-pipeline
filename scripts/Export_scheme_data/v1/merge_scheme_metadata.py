...
DATA_DIR = "data"
OUTPUT_FILE = os.path.join(DATA_DIR, "scheme_index.csv")
...
# ---------------- WRITE MASTER FILE ----------------
print(f"✍️ Writing master file to {OUTPUT_FILE} ...\n")
...
print(f"\n🎉 MF master file created at {OUTPUT_FILE} with {len(codes)} records ✅")
